  ...
  return (
    <div className="gauge-wrap">
      <svg viewBox="0 0 200 112" className="gauge">
        <path d="M 12 100 A 88 88 0 0 1 188 100" fill="none" stroke="#1e293b" strokeWidth="16" strokeLinecap="round" />
        <path
        ...
        <g transform={`rotate(${angle} 100 100)`}>
          <line x1="100" y1="100" x2="100" y2="34" stroke="#e2e8f0" strokeWidth="3" strokeLinecap="round" />
        </g>
